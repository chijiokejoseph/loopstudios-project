...
const /**@type {HTMLElement}*/ menuItem = document.querySelector('[title="menuItem"]');
...
let /**@type {string[]}*/ newHTML = [
    `<!--Third Header-->
  <header id="header2" class="bg-black text-white sm:hidden">
    <nav class="w-full px-4 py-4 space-y-8">
      <!-- Menu Icon Tray -->
      <div class="flex justify-end w-full h-12">
        <!-- Menu Icon -->
        <ul title="menuItem" class="relative w-8 h-12 group">
          <li class="bg-gradient-to-tr from-white to-white rounded-full w-8 h-1 absolute top-0 left-0 rotate-45 group-hover:from-purple-500 group-hover:to-red-500"></li>
          <li class="bg-gradient-to-tr from-white to-white rounded-full w-8 h-1 absolute top-0 left-0 -rotate-45 group-hover:from-purple-500 group-hover:to-red-500"></li>
        </ul>
      </div>
      <!-- Menu Items -->
      <ul class="ml-4 flex flex-col gap-2 nav-li-hover2">
        <li>
          <a href="#">About</a>
        </li>
        <li>
    ...
    `<!--Second Header-->
  <header id="header2" class="bg-[url('../assets/images/mobile/image-hero.jpg')] text-white sm:hidden space-y-8">
    <!-- Header Nav -->
    <nav class="w-full flex py-8 px-4 items-center gap-12 justify-between">
      <div class="flex flex-col font-bold">
        <svg class="w-full h-auto max-w-48" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 32">
          <path
      ...
      <!-- Hamburger Menu Icon -->
      <ul title="menuItem" class="flex flex-col flex-shrink-0 items-center py-2 px-2 w-12 h-12 gap-2 rounded-sm group transition duration-100 *:w-full *:bg-gradient-to-tr *:from-white *:to-white *:transition *:duration-700">
       <li class="h-1 w-12 rounded-full group-hover:from-purple-500 group-hover:to-red-500"></li>
       <li class="h-1 w-12 rounded-full group-hover:from-purple-500 group-hover:to-red-500"></li>
       <li class="h-1 w-12 rounded-full group-hover:from-purple-500 group-hover:to-red-500"></li>
      </ul>
    </nav>
    <!-- Header Hero -->
    <div class="p-4 border-2 ml-4 border-gray-200 rounded-sm w-4/6 max-w-lg">
      <h1 class="text-h1 uppercase">Impressive Experiences That Deliver</h1>
    </div>
    <div class="h-12"></div>
  </header>`
];
