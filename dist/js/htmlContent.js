    ...
    <nav class="w-full px-4 py-4 space-y-8">
      ...
      <div class="flex justify-end w-full h-12">
        ...
        <ul title="menuItem" class="relative w-8 h-12 group">
          <li class="bg-gradient-to-tr from-white to-white rounded-full w-8 h-1 absolute bottom-0 left-0 rotate-45 group-hover:from-purple-500 group-hover:to-red-500"></li>
          <li class="bg-gradient-to-tr from-white to-rose-300 rounded-full w-8 h-1 absolute bottom-0 left-0 -rotate-45 group-hover:from-purple-500 group-hover:to-red-500"></li>
        </ul>
      </div>
      <!-- Menu Items -->
      <ul class="px-4 flex flex-col w-full gap-2 nav-li-hover2">
        <li>
          <a href="#">About</a>
        </li>
        <li>
